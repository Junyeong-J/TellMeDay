...
- STT기능의 정확성과 음질 최적화
    ...
    - 또한, 음성 파일의 크기와 음질 사이의 균형을 맞추기 위해 다양한 샘플 레이트로 테스트를 진행했습니다.
      8,000Hz, 12,000Hz, 16,000Hz로 각각 실험한 결과, 16,000Hz에서 가장 높은 음질을 얻을 수 있었으나, 12,000Hz에서도 충분히 사용자들이 알아듣기 쉬운 음질을 제공했습니다.
